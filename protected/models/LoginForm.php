...
class LoginForm extends CFormModel {
  ...
  public function rules() {
    return array(
      ...
      array('username, password', 'required','message'=>"bu alan boş olamaz"),
  ...
  public function attributeLabels() {
    return array('rememberMe' => 'Şifremi Hatırla');
  }
  ...
  public function authenticate($attribute, $params) {
    if (!$this->hasErrors()){
      ...
      if (!$this->_identity->authenticate()) $this->addError('password', 'Kullanıcı adı veya Şifre yanlış');
    }
  }
