...
<head>
	...
	<!-- For all browsers -->
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/reset3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/style3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/colors3860.css?v=1">
	<link rel="stylesheet" media="print" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/print3860.css?v=1">
	<!-- For progressively larger displays -->
	<link rel="stylesheet" media="only all and (min-width: 480px)" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/4803860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 768px)" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/7683860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 992px)" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/9923860.css?v=1">
	<link rel="stylesheet" media="only all and (min-width: 1200px)" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/12003860.css?v=1">
	<!-- For Retina displays -->
	<link rel="stylesheet" media="only all and (-webkit-min-device-pixel-ratio: 1.5), only screen and (-o-min-device-pixel-ratio: 3/2), only screen and (min-device-pixel-ratio: 1.5)" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/2x3860.css?v=1">

	<!-- Webfonts -->
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:300' rel='stylesheet' type='text/css'>

	<!-- Additional styles -->
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/agenda3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/dashboard3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/form3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/modal3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/progress-slider3860.css?v=1">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/css/styles/switches3860.css?v=1">

	<!-- JavaScript at bottom except for Modernizr -->
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/libs/modernizr.custom.js"></script>

	<!-- For Modern Browsers -->
	<link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/favicons/favicon.png">
	<!-- For everything else -->
	<link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/favicons/favicon.ico">
	<!-- For retina screens -->
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/favicons/apple-touch-icon-retina.png">
	<!-- For iPad 1-->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/favicons/apple-touch-icon-ipad.png">
	<!-- For iPhone 3G, iPod Touch and Android -->
	<link rel="apple-touch-icon-precomposed" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/favicons/apple-touch-icon.png">
	...
	<link rel="apple-touch-startup-image" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
	<link rel="apple-touch-startup-image" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
	<link rel="apple-touch-startup-image" href="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
...
<body class="clearfix with-menu with-shortcuts">
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
			...
			<div id="profile">
				<img src="<?php echo Yii::app()->request->baseUrl; ?>/interface/img/user.png" width="64" height="64" alt="User name" class="user-icon">
				Hello
	...
	<!-- Scripts -->
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/libs/jquery-1.8.2.min.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/setup.js"></script>

	<!-- Template functions -->
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.input.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.message.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.modal.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.navigable.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.notify.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.scroll.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.progress-slider.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.tooltip.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.confirm.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.agenda.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/developr.tabs.js"></script>		<!-- Must be loaded last -->

	<!-- Tinycon -->
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/interface/js/libs/tinycon.min.js"></script>
				...
				notify.showNotificationPermission('Your browser supports desktop notification, click here to enable them.', function()
				{
					...
					if (notify.hasNotificationPermission())
					{
						notify('Notifications API enabled!', 'You can now see notifications even when the application is in background', {
							icon: '<?php echo Yii::app()->request->baseUrl; ?>/interface/img/demo/icon.png',
							system: true
						});
					}
					else
