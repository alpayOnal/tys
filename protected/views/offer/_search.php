...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'company_staff'); ?>
		<?php echo $form->textField($model,'company_staff',array('size'=>60,'maxlength'=>200)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'manage_note'); ?>
		<?php echo $form->textArea($model,'manage_note',array('rows'=>6, 'cols'=>50)); ?>
	</div>
